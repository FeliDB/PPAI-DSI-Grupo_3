...
# Crear detalle, muestra y serie temporal
detalle = DetalleMuestraSismica(9.8)
muestra = MuestraSismica(detalle)
serie_temporal = SerieTemporal(
    condicionAlarma="alarma leve",
    fechaHoraRegistroMuestras="2025-06-13 08:40:00",
    fechaHoraRegistro="2025-06-13 08:35:00",
    frecuenciaMuestreo=5
)

evento1 = EventoSismico("2025-06-13 09:10:00", "2025-06-13 08:55:00", -31.4201, -31.4255, -64.1888, obtener_estado("pendiente de revisión"), -64.1923, 5.2, cambio_estado_vacio, [serie_temporal], alcance_dummy, clasificacion_dummy, origen_dummy)
evento1.listaMuestrasSismicas = [muestra]
